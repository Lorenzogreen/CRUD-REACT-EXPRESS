...
const Nouveauconge = ({isAjout, cacherAjout})=>{
    ...
    const handleSubmit = e=>{
        e.preventDefault()
        axios.post('http://localhost:3001/personnel/ajoutere', personnel)
        .then(reponse =>{
                ...
                <div>
                    <form onSubmit = { handleSubmit }>
                        <div className = "container-input">
                            ...
                            <input type = "number" id = "rf_conge" required onChange = {changePersonnel} />
                        </div>
                        <div className = "container-input">
                            <label>CIN : </label>
                        ...
                        <div className = "container-input">
                            <label>Motif : </label>
                            <input type = "text" id = "Motif" required onChange = {changePersonnel} />
                        </div>
